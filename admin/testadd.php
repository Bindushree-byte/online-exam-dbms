...
{
extract($_POST);
mysqli_query($con,"insert into test(sub_id,test_name,total_que) values ('$subid','$testname','$totque')",$cn) or die(mysqli_error());
...
<?php
$rs=mysqli_query($con,"Select * from subject order by  sub_name",$cn);
