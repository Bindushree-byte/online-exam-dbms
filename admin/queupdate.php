...
extract($_REQUEST);
 $id=$_GET['que_id'];
$q=mysqli_query($con,"select * from question where que_id='$id'");
...
$query="update question SET que_desc='$addque',ans1='$ans1',ans2='$ans2',ans3='$ans3',ans4='$ans4',true_ans='$anstrue' where que_id='$id'";	
