...
{
$sql=mysqli_query($con,"select t.test_id AS test_id , t.test_name AS test_name , t.total_que AS total_que , s.sub_name AS sub_name from test t , subject s WHERE t.sub_id = s.sub_id");	
