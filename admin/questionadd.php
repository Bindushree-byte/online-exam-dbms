...
{
extract($_POST);
mysqli_query($con,"insert into question(test_id,que_desc,ans1,ans2,ans3,ans4,true_ans) values ('$testid','$addque','$ans1','$ans2','$ans3','$ans4','$anstrue')",$cn) or die(mysqli_error());
...
<?php
$rs=mysqli_query($con,"Select * from test order by test_name",$cn);
