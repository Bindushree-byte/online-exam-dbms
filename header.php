...
<!--<table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#000000" background="img/blackbar.jpg">
  ...
  ?>
	...
	{
	 echo "<div align=\"right\"><strong><a href=\"index.php\" class='nav-btn-rgit' style='margin:10px;'> Home </a><a href=\"signout.php\" class='nav-btn-rgit' style='margin:10px;'>Signout</a></strong></div>";
	 }
	 else
	 {
	 	echo "&nbsp;";
